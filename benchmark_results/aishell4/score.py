...
WORKSPACE    = "/workspace/benchmarks/aishell4"
...
MODELS_PATH  = "/workspace/models/ft_aishell4_f3600/models"
EPOCHS = "41-50"
SUBSAMP = "10"
...
audio_dir    = f"{WORKSPACE}/dataset/test/wav"      # contains <meeting_id>.wav
ref_rttm_dir = f"{WORKSPACE}/dataset/test/TextGrid"    # contains <meeting_id>.rttm
