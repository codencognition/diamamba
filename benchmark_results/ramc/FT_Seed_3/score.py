...
WORKSPACE    = "/workspace/benchmarks/ramc"
...
RUN_NAME = "model_FT_f3600"

# MODELS_PATH  = "/workspace/models/dr0p15_specaug_on/models"
# EPOCHS = "91-100"
# SUBSAMP = "10"

# MODELS_PATH  = "/workspace/models/ft_ramc_f1800/models"
# EPOCHS = "141-150"
# SUBSAMP = "10"

MODELS_PATH  = "/workspace/models/ft_ramc_f3600/models"
EPOCHS = "41-50"
SUBSAMP = "10"

# MODELS_PATH  = "/workspace/models/ft_ramc_f6000/models"
# EPOCHS = "141-150"
# SUBSAMP = "10"
...
audio_dir    = f"{WORKSPACE}/test/wav"      # contains <meeting_id>.wav
ref_rttm_dir = f"{WORKSPACE}/test/rttm"    # contains <meeting_id>.rttm
